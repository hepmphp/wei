 ...
 * 数组操作类
 * 合并数组                    Arr::merge()
 * 获取数组的默认值             Arr::getValue($_POST,'username','');
 * 删除指定键值的数组           Arr::remove($_POST,'useranme');
 * 用指定键值重新索引二维数组    Arr::index($user_list,'id');
 * 获取指定建的所有值           Arr::getColumn($user_list,'id')
 * 重新创建二维数组用指定的键和值 Arr::map($user_list,'id','username');
 *
 * Class Arr
 * @package helpers
 */
