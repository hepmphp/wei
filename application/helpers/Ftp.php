...
class Ftp {
   ...
   private static $ftp_instance=null;	
   public static function getInstance($config=array()){
        if(empty(self::$ftp_instance)){
            ...
            self::$ftp_instance =  new self($config);
		    self::$ftp_instance->connect(); 
        }
	...
	public function mkdir($path, $permissions = NULL)
	{
	  ...
	  function mk_subdirs($ftpbasedir,$ftpath){
