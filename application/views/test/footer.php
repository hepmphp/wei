		...
		<script src="<?=SITE_URL?>/static/assets/js/bootstrap.min.js"></script>
		<!-- page specific plugin scripts -->
		<!-- ace scripts -->
		<script src="<?=SITE_URL?>/static/assets/js/ace-elements.min.js"></script>
		<script src="<?=SITE_URL?>/static/assets/js/ace.min.js"></script>
